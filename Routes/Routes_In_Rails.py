...
Reduced route clutter: With manual routes, you only define the routes you actually need, 
  reducing the number of unused routes in the application.
...
Its common to use a combination of both approaches in larger Rails applications to strike a balance between 
